          ...
          <div class="col-md-6">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                  <a href="shop.html" class="text-decoration-none text-muted"
                    >Shop</a
                  >
                </li>
            ...
            <div class="mb-4">
              ...
              <div class="d-flex gap-3">
                <div
                  class="color-circle bg-dark active"
                  onclick="selectColor(this)"
                ></div>
                <div
                  class="color-circle bg-secondary"
                  onclick="selectColor(this)"
                ></div>
                <div
                  class="color-circle bg-white border"
                  onclick="selectColor(this)"
                ></div>
                <div
                  class="color-circle"
            ...
            <div class="mb-4">
              ...
              <div class="d-flex align-items-center">
                <button
                  class="quantity-btn rounded-start-5"
                ...
                />
                <button
                  class="quantity-btn rounded-end-5"
                  onclick="updateQuantity(1)"
                >
            ...
            <div class="mt-4">
              <div class="d-flex gap-3 text-muted small">
                ...
                <span
                  ><i class="bi bi-arrow-return-left me-1"></i>Easy Return</span
                >
                <span
          ...
          <div class="row">
            <div class="col-6 col-md-3 mb-3">
              <div class="card border-1 shadow-lg">
                ...
                />
                <div
                  class="card-body bg-white text-dark d-flex flex-column justify-content-between"
                >
                  <div>
                  ...
                  <a href="#" class="btn btn-dark rounded-5" type="submit"
                    >Buy</a
                  >
                </div>
              </div>
